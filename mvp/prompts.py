...
Step 2 : 4 parallel domain experts (Agents 1–4)
         ...
         ↑ Output format: [製程編號] [製程名稱] | VLM:[score] | 依據：[...]
...
# ── Domain process catalogue (static placeholder until real RAG is wired) ──
...
Arrive at a score between 0.00 and 1.00 that honestly reflects your certainty. Use 0.01 granularity (e.g., 0.37, 0.62, 0.83) — do NOT round to 0.05 increments. Explain your reasoning in the evidence field.
...
Arrive at a score between 0.00 and 1.00 using 0.01 granularity (e.g., 0.37, 0.62, 0.83) — do NOT round to 0.05 increments. Explain your reasoning in the evidence field.
