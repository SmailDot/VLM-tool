...
class VLMClient:
    ...
    SYSTEM_PROMPT = (
        ...
        "Based on the observations above: this is an <green>L-shaped Bracket</green>. "
        "It consists of a <green>Rectangular Base</green> with a <green>Flange</green> bent upward. "
        "Two <green>Thru-holes</green> are on the base. A <orange>Chamfer</orange> is on one corner.\n"
        "--- END OF EXAMPLE ---"
    )
